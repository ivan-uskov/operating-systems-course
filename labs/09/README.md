...
Внимание, в этом задании ваш сервер должен как отдавать статический контент
(код html-страниц, изображения и скрипты), так и обрабатывать запросы фронтенда к API.
В Boost.Beast есть пример HTTP-сервера, отдающего статический контент.
